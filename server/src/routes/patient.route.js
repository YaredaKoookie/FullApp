...
import { appointmentController, patientController, reviewController } from "../controllers";
...
router.post('/appointments/:doctorId/book', validate(appointmentChains.validateAppointmentCreation), appointmentController.requestAppointment);
router.get("/appointments", validate(appointmentChains.validateGetAppointments), appointmentController.getPatientAppointments);
