export const endpoints = {
  ...
  patient: {
    profile: {
      ...
      emergencyContact: {
        base: () => "/patient/profile/emergency-contact",
        byId: (contactId) => `/patient/profile/emergency-contact/${contactId}`,
      },
      insurance: {
        base: () => "/patient/profile/insurance",
        byId: (insuranceId) => `/patient/profile/insurance/${insuranceId}`,
      },
      medicalHistory: {
        ...
        conditions: {
          ...
          byId: (conditionId) =>
            `/patient/medical-history/conditions/${conditionId}`,
        },
        allergies: {
          base: () => "/patient/medical-history/allergies",
          byId: (allergyId) =>
            `/patient/medical-history/allergies/${allergyId}`,
        },
        surgeries: {
          base: () => "/patient/medical-history/surgeries",
          byId: (sergeryId) =>
            `/patient/medical-history/surgeries/${sergeryId}`,
        },
        medications: {
          base: () => "/patient/medical-history/medications/current",
          byId: (medicationId) =>
            `/patient/medical-history/medications/${medicationId}`,
          discontinue: (medicationId) =>
            `/patient/medical-history/medications/${medicationId}/discontinue`,
        },
        immunizations: {
          base: () => "/patient/medical-history/immunizations",
          byId: (immunizationId) =>
            `/patient/medical-history/immunizations/${immunizationId}`,
        },
        timeline: {
        ...
        hospitalizations: {
          ...
          byId: (hospitalizationId) =>
            `/patient/medical-history/hospitalizations/${hospitalizationId}`,
        },
        familyHistory: {
          base: () => "/patient/medical-history/family-history",
          byId: (recordId) =>
            `/patient/medical-history/family-history/${recordId}`,
      ...
      appointments: {
        ...
        reschedule: (doctorId) =>
          `/patient/appointments/${doctorId}/reschedule`,
        search: () => "/patient/appointments/search",
      },
      payments: {
        base: () => "/patient/payments",
        initiate: (appointmentId) =>
          `/patient/payments/appointments/${appointmentId}`,
