...
import { useAddImmunization } from "@api/patient"
...
const AddImmunizationModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const { mutateAsync } = useAddImmunization();
        ...
        <Dialog.Panel className="mx-auto md:w-lg max-w-lg rounded-lg bg-white p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="mt-6 flex justify-end space-x-3">
              ...
              >
                {isSubmitting ? 'Adding...' : 'Add Immunization'}
              </button>
            </div>
          </form>
        </Dialog.Panel>
