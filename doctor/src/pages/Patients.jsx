...
import { FaSearch, FaHistory, FaStickyNote, FaFileAlt } from "react-icons/fa";
...
const Patients = () => {
  ...
  const medicalRecordsQuery = useQuery({
    queryKey: ["medicalRecords", selectedPatient?._id],
    queryFn: async () => {
      if (!selectedPatient) {
        throw new Error("No patient selected");
      }
      console.log("Fetching medical records for patient:", selectedPatient._id);
      const response = await medicalRecordAPI.getPatientRecords(selectedPatient._id);
      console.log("Medical records response:", response);
      return response.data;
    },
    enabled: !!selectedPatient && showMyRecords,
    onError: (error) => {
  ...
  const handleViewMyRecords = (patient) => {
    console.log("Viewing records for patient:", patient);
    setSelectedPatient(patient);
      ...
      <div className="space-y-6">
                    ...
                    <tr key={patient._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-3">
                          ...
                          <button
                            onClick={() => handleViewMyRecords(patient)}
        ...
        {showMyRecords && selectedPatient && (
          <MedicalRecordModal
            ...
            currentDoctor={currentDoctor.data.data.doctor}
            existingRecords={medicalRecordsQuery.data || []}
            mode="view"
            readOnly={true}
          />
        )}
